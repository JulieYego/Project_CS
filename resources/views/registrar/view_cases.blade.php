                   ...
                   <table class="table table-dark table-striped table-hover" id="tbl_suspects">
                       ...
                       <tbody>
                           ...
                           <tr>
                               ...
                               <td>{{ $Cases->IDnumber}}</td>
                               <td>{{ $Cases->gender}}</td>
                               <td>{{ $Cases->officer}}</td>
                               <td>{{ $Cases->crime}}</td>
                               <td>{{ $Cases->place}}</td>
                               <td>{{ \Carbon\Carbon::parse($Cases->created_at)->toDayDateTimeString() }}</td>
                               <td>{{ \Carbon\Carbon::parse($Cases->present)->toDayDateTimeString() }}</td>
                               <td>{{ $Cases->status}}</td>
                               <td>{{ \Carbon\Carbon::parse($Cases->time_presented)->toDayDateTimeString() }}</td>
